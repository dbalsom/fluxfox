...
* `--sectors_only` - This flag will restrict writing of image data into sector data regions only. This will result
  ...
  <img src="doc/img/cat_in_sectors_02.png" width="640" />
...
<img src="doc/img/readback_02.png" width="640" />

I didn't even have a blank high density disk to use, so this is a high density image written to a double-density disk!

You can see the red line on the right side representing the write splice at index mark, as evidence this was actually
written.

## Wasn't the cat different before?

The original cat image was AI generated. This was a regrettable decision in hindsight. I have recreated everything
using an actual photo of my big orange doofus, Harry. Say Hi, Harry.

<img src="doc/img/harry.jpg" width="640" />
...
Disk surface visualizations aren't the only way we can encode pictures on floppy disks.

See my [pbm2track](../pbm2track) utility for an example of how to encode pixel art in your track timing diagrams.

![track_cats](../pbm2track/img/flux_cats_01.png)
